...
<div  style="height: 30px;width: 50%;margin-right: 5px;">
    <a href="javascript:void(0)" data-toggle="tooltip" data-original-title="Edit" onClick="showFunc({{ $id }})" class="btn btn-success d-xxl-flex justify-content-xxl-center align-items-xxl-center" type="button" style="width: 100%;height: 100%;">
        <i class="fa fa-eye"></i>
    </a>
</div>
<div  style="height: 30px;width: 50%;margin-right: 5px;">
